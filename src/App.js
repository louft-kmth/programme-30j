  ...
  },
  {
    ...
    blocks: [
      { icon: "🏃", title: "Séance A — Muscu lourde + Cardio long (~70 min) - Lundi-Jeudi-Samedi", type: "sport", exercises: [
        ...
        { name: "Marcy — Chest press + Butterfly + Écarté sol", badge: "muscu", detail: "TRI-SET pecs : chest press assis (charge max) → butterfly/pec deck → écarté haltères au sol. Charges max tolérables.", sets: "3 × 10 chaque · tri-set · 90s", muscles: ["pectoraux", "triceps"], img: "/images/ES4.png" },
